...
<tr><td colspan="4" style="text-align:center; text-transform:capitalize; font-weight:bold; font-size:16px; margin:auto; margin-bottom:20px;"><input type="text" class="form-control" name="table" id="table" style="float:left;" placeholder="Table no." autocomplete="Off" onkeyup="free_table()" </td> </tr>
...
<tr><td colspan="3" style="text-align:center; text-transform:capitalize; font-weight:bold; font-size:16px; margin-bottom:20px; "><?= CHtml::button('Checkout',array('class'=>'btn btn-warning','style'=>'margin:0px;','onclick'=>'lock("send"), checkout_rest()','id'=>'send')) ?><span id="loading3" style="display:none; "><?= CHtml::image(Yii::app()->baseUrl . "/loader/loader.gif","",array("style"=>"color:#fff;")) ?> </span></td>
