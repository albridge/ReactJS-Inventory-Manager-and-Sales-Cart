...
<div style="position:fixed; margin-top:110px; text-align:center; text-transform:capitalize; font-weight:bold; font-size:16px; margin-bottom:20px; "><?= CHtml::link('Send',Yii::app()->createUrl('front/summary'),array('class'=>'btn btn-warning','style'=>'margin:0px; padding:10px; font-size:1.5em; margin-top:30px;','id'=>'send','onclick'=>'lock("send")')) ?><span id="loading3" style="display:none; "><?= CHtml::image(Yii::app()->baseUrl . "/loader/loader.gif","",array("style"=>"color:#fff;")) ?> </span></div>
...
<div style="display:block;">
    ...
    <div id="loading2<?= $item->id ?>" style="display:none; text-align:center; text-transform:capitalize; font-weight:bold; font-size:36px; margin-top:20px; margin-bottom:20px;"><?= CHtml::image(Yii::app()->baseUrl . "/loader/loader.gif","",array("style"=>"color:#fff;")) ?> </div>
