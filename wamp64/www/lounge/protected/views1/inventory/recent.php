...
<div style="display:inline-block;">
 ...
 <?php if($position->closed==0 &&  Yii::app()->user->role=='accounts'
  )
 {  ?>
<div style="display:inline-block;">
...
if($position->closed==0 && Yii::app()->user->role=='accounts'){ 
...
<span style="text-align:center; text-transform:capitalize; font-weight:bold; font-size:16px;"> <input type="text" id="paid" class="form-control" placeholder="Enter Payment"> </span>
